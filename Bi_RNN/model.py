...
class Seq2SeqModel(object):
    def __init__(self, encoder_size, decoder_size, hidden_dim, input_dim, output_dim):
        ...
        encoder_cell_fw = tf.contrib.rnn.BasicRNNCell(hidden_dim)
        encoder_cell_bw = tf.contrib.rnn.BasicRNNCell(hidden_dim)
        ...
        decoder_cell = tf.contrib.rnn.BasicRNNCell(hidden_dim*2)
